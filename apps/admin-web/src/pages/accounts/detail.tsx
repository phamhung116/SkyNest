...
export const AccountDetailPage = () => {
  ...
  const deleteAccount = () => {
    if (account && window.confirm(`Xac nhan xoa account ${account.email}?`)) {
            ...
            <Panel className="admin-stack">
              <div className="admin-card__header">
                ...
                <div className="table-actions--inline">
                  ...
                  <Button variant="secondary" disabled={deleteMutation.isPending} onClick={deleteAccount}>
                    Xoa account
                  </Button>
                </div>
              </div>
              ...
              {!canEdit ? <p className="row-muted">Account customer chi duoc xem va xoa, khong sua thong tin tu admin.</p> : null}
